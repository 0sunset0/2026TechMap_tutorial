...
class ARCoordinator: NSObject, ARSessionDelegate {
    ...
    private func makeDominoEntity() -> ModelEntity {
        ...
        // massProperties: .default — 도미노 충돌 shape의 부피 기준으로 RealityKit이 자동 계산함
        domino.components.set(PhysicsBodyComponent(massProperties: .default, material: .default, mode: .dynamic))
